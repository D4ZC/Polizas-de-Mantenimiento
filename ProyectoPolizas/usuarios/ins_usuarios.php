<?php
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $caracteres = "ABCDEFGHIJKLMNÑOPQRSTUVWXYZ abcdefghijklmnñopqrstuvwxyz";
    ...
    if ($archivo  != '') {
      ...
      if ($ins) {
          header('location:../extend/alerta.php?msj=Usuario registrado correctamente&c=us&p=in&t=success');
          exit;
        }
      else {
